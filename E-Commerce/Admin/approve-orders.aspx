<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/master.Master" AutoEventWireup="true" CodeBehind="approve-orders.aspx.cs" Inherits="E_Commerce.Admin.approve_orders" %>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <i class="fa fa-shopping-cart"></i>&nbsp;Recent Order Details
                                </div>
                                                ...
                                                <asp:GridView ID="grdorders" runat="server" CssClass="height" AutoGenerateColumns="false" AllowPaging="true" PageSize="15" OnPageIndexChanging="grdorders_PageIndexChanging" EmptyDataText="No Record Available As Of Now" EmptyDataRowStyle-CssClass="text-white" Font-Bold="true" Font-Size="12px" HeaderStyle-Font-Names="CourierNew" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="Black" ShowFooter="true" OnRowEditing="grdorders_RowEditing" OnRowDeleting="grdorders_RowDeleting" OnRowCommand="grdorders_RowCommand" OnRowDataBound="grdorders_RowDataBound">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="S.No" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="5%">
                                                            <HeaderTemplate>
                                                                <asp:TextBox ID="txtsnno" runat="server" CssClass="dropdownlists height" placeholder="S.No" ForeColor="Black" Width="80px" Font-Size="Medium" ReadOnly="true"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                            <HeaderTemplate>
                                                                <asp:TextBox runat="server" CssClass="dropdownlists height" placeholder=" Date" ForeColor="Black" Width="80px" Font-Size="Medium" onkeyup="searchTable(this,1)"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                            <HeaderTemplate>
                                                                <asp:TextBox runat="server" CssClass="dropdownlists height" placeholder="Approval Date" ForeColor="Black" Width="120px" Font-Size="Medium" onkeyup="searchTable(this,2)"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                            <HeaderTemplate>
                                                                <asp:TextBox runat="server" CssClass="dropdownlists height" placeholder=" Order Number" ForeColor="Black" Width="120px" Font-Size="Medium" onkeyup="searchTable(this,3)"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                            <HeaderTemplate>
                                                                <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,4)" placeholder="Customer Name" ForeColor="Black" Width="150px" Font-Size="Medium"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                            <HeaderTemplate>
                                                                <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,4)" placeholder="Total Amount" ForeColor="Black" Width="100px" Font-Size="Medium"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                            <HeaderTemplate>
                                                                <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,5)" placeholder="Approved" ForeColor="Black" Width="100px" Font-Size="Medium"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                            <HeaderTemplate>
                                                                <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,6)" placeholder="Delivered" ForeColor="Black" Width="100px" Font-Size="Medium"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Action" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="5%">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:LinkButton ID="lnkapproved" runat="server" CssClass="fa fa-check-square fa-1x" ForeColor="Red" CommandName="approved" CommandArgument='<%# Eval("orderno") %>' Font-Bold="true" OnClientClick="if ( !confirm('Do you want approved this Order ?')) return false;" ToolTip="Approve"></asp:LinkButton>

                                                                &nbsp;|&nbsp;
                                                                <asp:LinkButton ID="lnkdelivered" runat="server" CssClass="fa fa-check fa-1x" ForeColor="Blue" CommandName="delivered" CommandArgument='<%# Eval("orderno") %>' Font-Bold="true" OnClientClick="if ( !confirm('Is This Order Delivered ?')) return false;" ToolTip="Deliverd"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
