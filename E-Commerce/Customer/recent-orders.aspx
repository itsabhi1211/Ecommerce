<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Master.Master" AutoEventWireup="true" CodeBehind="recent-orders.aspx.cs" Inherits="E_Commerce.Customer.recent_orders" %>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow-lg mb-4 border-bottom-primary">
                    <div class="card-header bg-gradient-primary">
                        <div class="text-left">
                            <h5 class="text-white"><i class="fa fa-shopping-cart"></i>&nbsp;Recently Placed Orders</h5>
                                ...
                                <div class="table-bordered" style="height: 500px; overflow: auto;">
                                    <asp:GridView ID="grdorders" ShowFooter="true" runat="server" CssClass="height" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EmptyDataText="No Record Available As Of Now" EmptyDataRowStyle-CssClass="text-danger" Font-Bold="true" Font-Size="10px" HeaderStyle-Font-Names="CourierNew" HeaderStyle-Font-Italic="true" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="Black" OnPageIndexChanging="grdorder_PageIndexChanging" ForeColor="Black" OnRowDataBound="grdorder_RowDataBound" OnRowCommand="grdorders_RowCommand" OnRowDeleting="grdorders_RowDeleting" OnRowEditing="grdorders_RowEditing">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                <HeaderTemplate>
                                                    <asp:TextBox runat="server" CssClass="dropdownlists height" placeholder=" Order Number" ForeColor="Black" Width="200px" Font-Size="Medium" onkeyup="searchTable(this,3)"></asp:TextBox>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                <HeaderTemplate>
                                                    <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,4)" placeholder="Customer Name" ForeColor="Black" Width="220px" Font-Size="Medium"></asp:TextBox>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                <HeaderTemplate>
                                                    <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,5)" placeholder="Approved" ForeColor="Black" Width="150px" Font-Size="Medium"></asp:TextBox>
                                            ...
                                            <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                <HeaderTemplate>
                                                    <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,6)" placeholder="Delivered" ForeColor="Black" Width="150px" Font-Size="Medium"></asp:TextBox>
