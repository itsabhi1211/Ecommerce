<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Master.Master" AutoEventWireup="true" CodeBehind="track-order.aspx.cs" Inherits="E_Commerce.Customer.track_order" %>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card shadow-lg mb-4 border-bottom-primary">
                            <div class="card-header bg-gradient-primary">
                                <div class="text-left">
                                    <h5 class="text-white"><i class="fa fa-shopping-cart"></i>&nbsp;Track Your Order Here</h5>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="txtorderno" runat="server" class="form-control" placeholder="Order Number" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-right">
                                            ...
                                            <asp:Button runat="server" CssClass="btn btn-primary btn-block" Text="Track Order" ID="btndetails" OnClick="btndetails_Click" />
                                        </div>
                    ...
                    <div class="col-md-8">
                        <div class="card shadow-lg mb-4 border-bottom-primary">
                            <div class="card-header bg-gradient-primary">
                                <div class="text-left">
                                    <h5 class="text-white"><i class="fa fa-shopping-cart"></i>&nbsp;Orders Details</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-bordered" style="overflow: auto;">
                                            <asp:GridView ID="grdorders" ShowFooter="true" runat="server" CssClass="height" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EmptyDataText="No Record Available As Of Now" EmptyDataRowStyle-CssClass="text-danger" Font-Bold="true" Font-Size="10px" HeaderStyle-Font-Names="CourierNew" HeaderStyle-Font-Italic="true" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="Black" ForeColor="Black">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                        <HeaderTemplate>
                                                            <asp:TextBox runat="server" CssClass="dropdownlists height" placeholder="Order Date" ForeColor="Black" Width="75px" Font-Size="Medium" onkeyup="searchTable(this,1)"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                        <HeaderTemplate>
                                                            <asp:TextBox runat="server" CssClass="dropdownlists height" placeholder="Approval Date" ForeColor="Black" Width="110px" Font-Size="Medium" onkeyup="searchTable(this,2)"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                        <HeaderTemplate>
                                                            <asp:TextBox runat="server" CssClass="dropdownlists height" placeholder=" Order Number" ForeColor="Black" Width="125px" Font-Size="Medium" onkeyup="searchTable(this,3)"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                        <HeaderTemplate>
                                                            <asp:TextBox runat="server" CssClass="dropdownlists height" placeholder="Payment Mode" ForeColor="Black" Width="120px" Font-Size="Medium" onkeyup="searchTable(this,4)"></asp:TextBox>

                                                        </HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblpay" runat="server" Text='<%# Eval("paymentmode") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                        <HeaderTemplate>
                                                            <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,5)" placeholder="Approved" ForeColor="Black" Width="90px" Font-Size="Medium"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-center text-white" HeaderStyle-Width="8%">
                                                        <HeaderTemplate>
                                                            <asp:TextBox runat="server" CssClass="dropdownlists height" onkeyup="searchTable(this,6)" placeholder="Delivered" ForeColor="Black" Width="90px" Font-Size="Medium"></asp:TextBox>
