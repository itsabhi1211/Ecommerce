<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="sign-up.aspx.cs" Inherits="E_Commerce.sign_up" %>
            ...
            <section class="cart-section spad">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6" id="divbuyer" runat="server">
                            <div class="cart-table text-center">
                                <h3>Sign Up</h3>
                                <div class="promo-code-form">
                                    <div class="form-group text-left">
                                        <h5>Name</h5>
                                        <input type="text" placeholder="Enter name" runat="server" id="txtname" required="required">

                                        <div class="form-group"></div>
                                        <h5>Contact Number</h5>
                                        <input type="text" placeholder="Enter Contact No." runat="server" id="txtcontactno" pattern="[0-9]{10}" title="Please enter a valid contact no.." required="required">
                                        <div class="form-group"></div>
                                        <h5>E-Mail Id</h5>
                                        <input type="text" placeholder="Enter E-Mail Id" runat="server" id="txtemail" pattern="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" title="Please enter a valid email-Id.." required="required">
                                        <div class="form-group"></div>
                                        <h5>City</h5>
                                         <input type="text" placeholder="Confirm Password" runat="server" id="txtcity" required="required">
                                         <div class="form-group"></div>
                                        <h5>Password</h5>
                                        <input type="Password" placeholder="Enter Password" runat="server" id="txtpwd" required="required">
                                        <div class="form-group"></div>
                                        <h5>Confirm Password</h5>
                                       <input type="Password" placeholder="Enter Password" runat="server" id="txtcnfpwd" required="required">
                                        <div class="form-group"></div>
                                         

                                        <asp:Button runat="server" ID="btnsignin" CssClass="site-btn submit-order-btn" Text="Sign Up" OnClick="btnsignin_Click"></asp:Button>
